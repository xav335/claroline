...
namespace Proxies\__CG__\HeVinci\UrlBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Url extends \HeVinci\UrlBundle\Entity\Url implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'url', 'internalUrl', 'id', 'resourceNode', 'name', 'mimeType'];
        }
    ...
    public function setInternalUrl($internalUrl)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setInternalUrl', [$internalUrl]);

        return parent::setInternalUrl($internalUrl);
    }
    ...
    public function getInternalUrl()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getInternalUrl', []);

        return parent::getInternalUrl();
    }
