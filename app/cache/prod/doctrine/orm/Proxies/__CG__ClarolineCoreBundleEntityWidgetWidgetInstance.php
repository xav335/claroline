 ...
 */
class WidgetInstance extends \Claroline\CoreBundle\Entity\Widget\WidgetInstance implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'workspace', 'user', 'widget', 'isAdmin', 'isDesktop', 'name', 'icon', 'widgetDisplayConfigs', 'template'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WidgetInstance $proxy) {
    ...
    public function setIsAdmin($bool)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsAdmin', [$bool]);

        return parent::setIsAdmin($bool);
    }
    ...
    public function setIsDesktop($bool)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsDesktop', [$bool]);

        return parent::setIsDesktop($bool);
    }
    ...
    public function getWidgetDisplayConfigs()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getWidgetDisplayConfigs', []);

        return parent::getWidgetDisplayConfigs();
    }
