 ...
 */
class ProfileProperty extends \Claroline\CoreBundle\Entity\ProfileProperty implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'isEditable', 'role', 'property'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProfileProperty $proxy) {
    ...
    public function setIsEditable($bool)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsEditable', [$bool]);

        return parent::setIsEditable($bool);
    }
