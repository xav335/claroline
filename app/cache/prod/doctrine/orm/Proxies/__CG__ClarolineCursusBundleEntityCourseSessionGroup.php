 ...
 */
class CourseSessionGroup extends \Claroline\CursusBundle\Entity\CourseSessionGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'group', 'session', 'registrationDate', 'groupType'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CourseSessionGroup $proxy) {
