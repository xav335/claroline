 ...
 */
class ObjectiveProgressLog extends \HeVinci\CompetencyBundle\Entity\Progress\ObjectiveProgressLog implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'HeVinci\\CompetencyBundle\\Entity\\Progress\\ObjectiveProgressLog' . "\0" . 'date', 'id', 'objective', 'user', 'percentage', 'objectiveName', 'userName'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ObjectiveProgressLog $proxy) {
