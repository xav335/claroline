 ...
 */
class LikeAction extends \Icap\SocialmediaBundle\Entity\LikeAction implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'url', 'title', 'creationDate', 'resource', 'user'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LikeAction $proxy) {
