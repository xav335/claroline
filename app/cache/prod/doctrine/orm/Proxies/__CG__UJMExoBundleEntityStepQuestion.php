 ...
 */
class StepQuestion extends \UJM\ExoBundle\Entity\StepQuestion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'UJM\\ExoBundle\\Entity\\StepQuestion' . "\0" . 'step', '' . "\0" . 'UJM\\ExoBundle\\Entity\\StepQuestion' . "\0" . 'question', '' . "\0" . 'UJM\\ExoBundle\\Entity\\StepQuestion' . "\0" . 'order'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StepQuestion $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setStep(\UJM\ExoBundle\Entity\Step $step)
    {
