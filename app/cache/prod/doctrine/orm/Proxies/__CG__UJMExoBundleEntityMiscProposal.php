 ...
 */
class Proposal extends \UJM\ExoBundle\Entity\Misc\Proposal implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Misc\\Proposal' . "\0" . 'id', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Misc\\Proposal' . "\0" . 'uuid', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Misc\\Proposal' . "\0" . 'interactionMatching', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Misc\\Proposal' . "\0" . 'order', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Misc\\Proposal' . "\0" . 'data', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Misc\\Proposal' . "\0" . 'resourceNode'];
        }
    ...
    public function getInteractionMatching()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getInteractionMatching', []);

        return parent::getInteractionMatching();
    }

    /**
     * {@inheritDoc}
     */
    public function setInteractionMatching(\UJM\ExoBundle\Entity\QuestionType\MatchQuestion $interactionMatching)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setInteractionMatching', [$interactionMatching]);

        return parent::setInteractionMatching($interactionMatching);
    }
