 ...
 */
class RelWorkspaceTag extends \Claroline\CoreBundle\Entity\Workspace\RelWorkspaceTag implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'workspace', 'tag'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RelWorkspaceTag $proxy) {
