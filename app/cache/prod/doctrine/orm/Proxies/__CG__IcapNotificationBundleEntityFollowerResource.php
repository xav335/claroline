 ...
 */
class FollowerResource extends \Icap\NotificationBundle\Entity\FollowerResource implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'hash', 'resourceClass', 'resourceId', 'followerId'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FollowerResource $proxy) {
    ...
    public function setFollowerId($followerId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFollowerId', [$followerId]);
