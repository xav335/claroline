 ...
 */
class WorkspaceRegistrationQueue extends \Claroline\CoreBundle\Entity\Workspace\WorkspaceRegistrationQueue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'role', 'user', 'workspace'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WorkspaceRegistrationQueue $proxy) {
