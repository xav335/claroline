 ...
 */
class QuestionObject extends \UJM\ExoBundle\Entity\Question\QuestionObject implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Question\\QuestionObject' . "\0" . 'id', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Question\\QuestionObject' . "\0" . 'question', 'resourceNode'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (QuestionObject $proxy) {
