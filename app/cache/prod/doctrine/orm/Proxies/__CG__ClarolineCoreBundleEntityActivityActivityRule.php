 ...
 */
class ActivityRule extends \Claroline\CoreBundle\Entity\Activity\ActivityRule implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'activityParameters', 'isResultVisible', 'id', 'occurrence', 'action', 'result', 'resultMax', 'resultComparison', 'resource', 'userType', 'user', 'activeFrom', 'activeUntil'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ActivityRule $proxy) {
    ...
    public function getIsResultVisible()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIsResultVisible', []);

        return parent::getIsResultVisible();
    }
    ...
    public function setIsResultVisible($isResultVisible)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsResultVisible', [$isResultVisible]);

        return parent::setIsResultVisible($isResultVisible);
    }
