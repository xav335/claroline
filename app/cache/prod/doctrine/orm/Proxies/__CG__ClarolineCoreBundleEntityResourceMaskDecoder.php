 ...
 */
class MaskDecoder extends \Claroline\CoreBundle\Entity\Resource\MaskDecoder implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'value', 'name', 'resourceType'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MaskDecoder $proxy) {
    ...
    public function setValue($position)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setValue', [$position]);

        return parent::setValue($position);
    }
