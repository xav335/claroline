 ...
 */
class GridItem extends \UJM\ExoBundle\Entity\Misc\GridItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Misc\\GridItem' . "\0" . 'id', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Misc\\GridItem' . "\0" . 'coordsX', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Misc\\GridItem' . "\0" . 'coordsY', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Misc\\GridItem' . "\0" . 'uuid', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Misc\\GridItem' . "\0" . 'data', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Misc\\GridItem' . "\0" . 'resourceNode'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GridItem $proxy) {
    ...
    public function getCoordsX()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCoordsX', []);

        return parent::getCoordsX();
    }
    ...
    public function setCoordsX($coordsX)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCoordsX', [$coordsX]);

        return parent::setCoordsX($coordsX);
    }
    ...
    public function getCoordsY()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCoordsY', []);

        return parent::getCoordsY();
    }
    ...
    public function setCoordsY($coordsY)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCoordsY', [$coordsY]);

        return parent::setCoordsY($coordsY);
    }
