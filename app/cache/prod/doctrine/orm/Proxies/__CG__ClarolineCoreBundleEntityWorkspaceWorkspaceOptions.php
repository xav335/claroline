 ...
 */
class WorkspaceOptions extends \Claroline\CoreBundle\Entity\Workspace\WorkspaceOptions implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'workspace', 'details'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WorkspaceOptions $proxy) {
