...
namespace Proxies\__CG__\Icap\SocialmediaBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class CommentAction extends \Icap\SocialmediaBundle\Entity\CommentAction implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'text', 'id', 'url', 'title', 'creationDate', 'resource', 'user'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CommentAction $proxy) {
