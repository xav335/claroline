 ...
 */
class CourseRegistrationQueue extends \Claroline\CursusBundle\Entity\CourseRegistrationQueue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'user', 'course', 'applicationDate', 'status', 'validationDate', 'userValidationDate', 'validatorValidationDate', 'validator', 'organizationValidationDate', 'organizationAdmin'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CourseRegistrationQueue $proxy) {
