 ...
 */
class PortfolioGroup extends \Icap\PortfolioBundle\Entity\PortfolioGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'group', 'portfolio'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PortfolioGroup $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setPortfolio(\Icap\PortfolioBundle\Entity\Portfolio $portfolio)
    {
