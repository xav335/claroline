 ...
 */
class PortfolioGuide extends \Icap\PortfolioBundle\Entity\PortfolioGuide implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'user', 'portfolio', 'commentsViewAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PortfolioGuide $proxy) {
