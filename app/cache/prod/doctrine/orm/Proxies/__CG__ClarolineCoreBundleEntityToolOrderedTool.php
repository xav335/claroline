 ...
 */
class OrderedTool extends \Claroline\CoreBundle\Entity\Tool\OrderedTool implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'workspace', 'tool', 'order', 'name', 'isVisibleInDesktop', 'user', 'rights', 'type', 'locked'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OrderedTool $proxy) {
    ...
    public function isVisibleInDesktop()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isVisibleInDesktop', []);

        return parent::isVisibleInDesktop();
    }
    ...
    public function setVisibleInDesktop($isVisible)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setVisibleInDesktop', [$isVisible]);

        return parent::setVisibleInDesktop($isVisible);
    }
     ...
     * {@inheritDoc}
     */
    public function addRight(\Claroline\CoreBundle\Entity\Tool\ToolRights $right)
    {
