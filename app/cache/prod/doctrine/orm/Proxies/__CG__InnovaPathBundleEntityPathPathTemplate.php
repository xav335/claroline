 ...
 */
class PathTemplate extends \Innova\PathBundle\Entity\Path\PathTemplate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Innova\\PathBundle\\Entity\\Path\\PathTemplate' . "\0" . 'id', 'name', 'breadcrumbs', 'structure'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PathTemplate $proxy) {
