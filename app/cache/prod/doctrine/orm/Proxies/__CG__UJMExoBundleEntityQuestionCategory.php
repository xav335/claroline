 ...
 */
class Category extends \UJM\ExoBundle\Entity\Question\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Question\\Category' . "\0" . 'id', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Question\\Category' . "\0" . 'uuid', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Question\\Category' . "\0" . 'name', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Question\\Category' . "\0" . 'default', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Question\\Category' . "\0" . 'user'];
        }
