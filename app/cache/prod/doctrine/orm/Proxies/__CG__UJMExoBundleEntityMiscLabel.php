 ...
 */
class Label extends \UJM\ExoBundle\Entity\Misc\Label implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Misc\\Label' . "\0" . 'id', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Misc\\Label' . "\0" . 'uuid', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Misc\\Label' . "\0" . 'interactionMatching', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Misc\\Label' . "\0" . 'order', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Misc\\Label' . "\0" . 'data', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Misc\\Label' . "\0" . 'resourceNode'];
        }
