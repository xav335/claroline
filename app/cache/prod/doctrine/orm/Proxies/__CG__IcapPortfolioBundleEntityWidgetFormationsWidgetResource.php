 ...
 */
class FormationsWidgetResource extends \Icap\PortfolioBundle\Entity\Widget\FormationsWidgetResource implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'resource', '' . "\0" . 'Icap\\PortfolioBundle\\Entity\\Widget\\FormationsWidgetResource' . "\0" . 'widget', 'uri', 'uriLabel'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FormationsWidgetResource $proxy) {
