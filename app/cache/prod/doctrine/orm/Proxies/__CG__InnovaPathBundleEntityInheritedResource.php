 ...
 */
class InheritedResource extends \Innova\PathBundle\Entity\InheritedResource implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Innova\\PathBundle\\Entity\\InheritedResource' . "\0" . 'id', '' . "\0" . 'Innova\\PathBundle\\Entity\\InheritedResource' . "\0" . 'lvl', '' . "\0" . 'Innova\\PathBundle\\Entity\\InheritedResource' . "\0" . 'step', '' . "\0" . 'Innova\\PathBundle\\Entity\\InheritedResource' . "\0" . 'resource'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (InheritedResource $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setResource(\Claroline\CoreBundle\Entity\Resource\ResourceNode $resource)
    {
