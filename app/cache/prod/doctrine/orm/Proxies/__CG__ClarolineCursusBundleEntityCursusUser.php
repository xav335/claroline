 ...
 */
class CursusUser extends \Claroline\CursusBundle\Entity\CursusUser implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'user', 'cursus', 'registrationDate', 'userType'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CursusUser $proxy) {
