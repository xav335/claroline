 ...
 */
class CourseSessionUser extends \Claroline\CursusBundle\Entity\CourseSessionUser implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'user', 'session', 'registrationDate', 'userType'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CourseSessionUser $proxy) {
