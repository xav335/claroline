 ...
 */
class FormationsWidget extends \Icap\PortfolioBundle\Entity\Widget\FormationsWidget implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'widgetType', 'name', 'startDate', 'endDate', 'resources', 'establishmentName', 'diploma', 'id', 'label', 'createdAt', 'updatedAt', 'portfolioWidgets', 'user'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FormationsWidget $proxy) {
    ...
    public function getDiploma()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDiploma', []);

        return parent::getDiploma();
    }
    ...
    public function setDiploma($diploma)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDiploma', [$diploma]);

        return parent::setDiploma($diploma);
    }
