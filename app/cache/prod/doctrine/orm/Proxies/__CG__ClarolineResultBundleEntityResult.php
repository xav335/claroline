...
namespace Proxies\__CG__\Claroline\ResultBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Result extends \Claroline\ResultBundle\Entity\Result implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Claroline\\ResultBundle\\Entity\\Result' . "\0" . 'date', '' . "\0" . 'Claroline\\ResultBundle\\Entity\\Result' . "\0" . 'marks', '' . "\0" . 'Claroline\\ResultBundle\\Entity\\Result' . "\0" . 'total', 'id', 'resourceNode', 'name', 'mimeType'];
        }
     ...
     * {@inheritDoc}
     */
    public function addMark(\Claroline\ResultBundle\Entity\Mark $mark)
    {
