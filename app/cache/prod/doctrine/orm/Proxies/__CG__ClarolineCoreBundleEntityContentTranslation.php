 ...
 */
class ContentTranslation extends \Claroline\CoreBundle\Entity\ContentTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ContentTranslation $proxy) {
