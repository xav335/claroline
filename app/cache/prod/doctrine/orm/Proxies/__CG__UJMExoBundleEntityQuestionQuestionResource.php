 ...
 */
class QuestionResource extends \UJM\ExoBundle\Entity\Question\QuestionResource implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Question\\QuestionResource' . "\0" . 'id', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Question\\QuestionResource' . "\0" . 'question', 'resourceNode'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (QuestionResource $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setQuestion(\UJM\ExoBundle\Entity\Question\Question $question = NULL)
    {
