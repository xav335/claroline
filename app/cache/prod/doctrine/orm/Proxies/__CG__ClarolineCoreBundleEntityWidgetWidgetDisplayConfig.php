 ...
 */
class WidgetDisplayConfig extends \Claroline\CoreBundle\Entity\Widget\WidgetDisplayConfig implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'workspace', 'user', 'widgetInstance', 'row', 'column', 'width', 'height', 'color', 'details'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WidgetDisplayConfig $proxy) {
