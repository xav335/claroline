 ...
 */
class Period extends \Claroline\CoreBundle\Entity\Calendar\Period implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'start', 'end', 'year', 'description', 'name', 'timeSlots'];
        }
     ...
     * {@inheritDoc}
     */
    public function setYear(\Claroline\CoreBundle\Entity\Calendar\Year $year)
    {
