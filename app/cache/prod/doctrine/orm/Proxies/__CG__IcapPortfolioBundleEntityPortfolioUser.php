 ...
 */
class PortfolioUser extends \Icap\PortfolioBundle\Entity\PortfolioUser implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'user', 'portfolio'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PortfolioUser $proxy) {
