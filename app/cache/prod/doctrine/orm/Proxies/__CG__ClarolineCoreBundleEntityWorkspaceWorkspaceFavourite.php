 ...
 */
class WorkspaceFavourite extends \Claroline\CoreBundle\Entity\Workspace\WorkspaceFavourite implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'workspace', 'user'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WorkspaceFavourite $proxy) {
