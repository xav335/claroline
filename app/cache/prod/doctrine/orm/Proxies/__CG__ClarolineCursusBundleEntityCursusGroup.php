 ...
 */
class CursusGroup extends \Claroline\CursusBundle\Entity\CursusGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'group', 'cursus', 'registrationDate', 'groupType'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CursusGroup $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setGroup(\Claroline\CoreBundle\Entity\Group $group)
    {
     ...
     * {@inheritDoc}
     */
    public function setCursus(\Claroline\CursusBundle\Entity\Cursus $cursus)
    {
