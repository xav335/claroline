 ...
 */
class Category extends \Claroline\ForumBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'forum', 'subjects', 'creationDate', 'modificationDate', 'name'];
        }
     ...
     * {@inheritDoc}
     */
    public function addSubject(\Claroline\ForumBundle\Entity\Subject $subject)
    {
     ...
     * {@inheritDoc}
     */
    public function removeSubject(\Claroline\ForumBundle\Entity\Subject $subject)
    {
