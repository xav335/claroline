 ...
 */
class Hint extends \UJM\ExoBundle\Entity\Question\Hint implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Question\\Hint' . "\0" . 'id', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Question\\Hint' . "\0" . 'question', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Question\\Hint' . "\0" . 'uuid', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Question\\Hint' . "\0" . 'data', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Question\\Hint' . "\0" . 'resourceNode', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Question\\Hint' . "\0" . 'penalty'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Hint $proxy) {
