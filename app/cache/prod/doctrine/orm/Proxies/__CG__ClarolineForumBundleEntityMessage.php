 ...
 */
class Message extends \Claroline\ForumBundle\Entity\Message implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'content', 'creationDate', 'updated', 'subject', 'creator', 'author'];
        }
     ...
     * {@inheritDoc}
     */
    public function setSubject(\Claroline\ForumBundle\Entity\Subject $subject)
    {
