 ...
 */
class Document extends \Innova\CollecticielBundle\Entity\Document implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'type', 'url', 'resourceNode', 'comments', 'notations', 'validate', 'documentDate', 'drop', 'sender', 'title'];
        }
    ...
    public function getUnReadComments($userId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUnReadComments', [$userId]);

        return parent::getUnReadComments($userId);
    }
