 ...
 */
class ActivityRuleAction extends \Claroline\CoreBundle\Entity\Activity\ActivityRuleAction implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'resourceType', 'action'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ActivityRuleAction $proxy) {
