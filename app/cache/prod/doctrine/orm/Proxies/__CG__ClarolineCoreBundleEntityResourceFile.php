 ...
 */
class File extends \Claroline\CoreBundle\Entity\Resource\File implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'size', 'hashName', 'id', 'resourceNode', 'name', 'mimeType'];
        }
