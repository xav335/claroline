 ...
 */
class SessionEventComment extends \Claroline\CursusBundle\Entity\SessionEventComment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'content', 'user', 'sessionEvent', 'creationDate', 'editionDate'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SessionEventComment $proxy) {
