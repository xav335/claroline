 ...
 */
class Lesson extends \Icap\LessonBundle\Entity\Lesson implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Icap\\LessonBundle\\Entity\\Lesson' . "\0" . 'root', 'id', 'resourceNode', 'name', 'mimeType'];
        }
