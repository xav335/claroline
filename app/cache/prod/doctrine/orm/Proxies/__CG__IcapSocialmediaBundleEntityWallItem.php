 ...
 */
class WallItem extends \Icap\SocialmediaBundle\Entity\WallItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'like', 'share', 'comment', 'creationDate', 'user', 'visible'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WallItem $proxy) {
