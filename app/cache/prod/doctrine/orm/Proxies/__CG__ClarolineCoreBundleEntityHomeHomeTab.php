 ...
 */
class HomeTab extends \Claroline\CoreBundle\Entity\Home\HomeTab implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'type', 'user', 'workspace', 'widgetHomeTabConfigs', 'roles', 'icon'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (HomeTab $proxy) {
    ...
    public function getWidgetHomeTabConfigs()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getWidgetHomeTabConfigs', []);

        return parent::getWidgetHomeTabConfigs();
    }
    ...
    public function emptyRoles()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'emptyRoles', []);

        return parent::emptyRoles();
    }
