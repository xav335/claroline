 ...
 */
class PortfolioTeam extends \Icap\PortfolioBundle\Entity\PortfolioTeam implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'team', 'portfolio'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PortfolioTeam $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setTeam(\Claroline\TeamBundle\Entity\Team $team)
    {
