 ...
 */
class HomeTabConfig extends \Claroline\CoreBundle\Entity\Home\HomeTabConfig implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'homeTab', 'user', 'workspace', 'type', 'visible', 'locked', 'tabOrder', 'details'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (HomeTabConfig $proxy) {
    ...
    public function getTabOrder()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTabOrder', []);

        return parent::getTabOrder();
    }
    ...
    public function setTabOrder($tabOrder)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTabOrder', [$tabOrder]);

        return parent::setTabOrder($tabOrder);
    }
