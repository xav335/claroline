 ...
 */
class AdminTool extends \Claroline\CoreBundle\Entity\Tool\AdminTool implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'roles', 'class', 'plugin'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AdminTool $proxy) {
