 ...
 */
class BadgeTranslation extends \Icap\BadgeBundle\Entity\BadgeTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'badge', 'locale', 'name', 'description', 'slug', 'criteria'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BadgeTranslation $proxy) {
