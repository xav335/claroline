 ...
 */
class Scorm2004Resource extends \Claroline\ScormBundle\Entity\Scorm2004Resource implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Scorm2004Resource $proxy) {
