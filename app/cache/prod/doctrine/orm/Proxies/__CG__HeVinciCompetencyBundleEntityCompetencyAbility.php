 ...
 */
class CompetencyAbility extends \HeVinci\CompetencyBundle\Entity\CompetencyAbility implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'HeVinci\\CompetencyBundle\\Entity\\CompetencyAbility' . "\0" . 'id', '' . "\0" . 'HeVinci\\CompetencyBundle\\Entity\\CompetencyAbility' . "\0" . 'competency', '' . "\0" . 'HeVinci\\CompetencyBundle\\Entity\\CompetencyAbility' . "\0" . 'ability', '' . "\0" . 'HeVinci\\CompetencyBundle\\Entity\\CompetencyAbility' . "\0" . 'level'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CompetencyAbility $proxy) {
