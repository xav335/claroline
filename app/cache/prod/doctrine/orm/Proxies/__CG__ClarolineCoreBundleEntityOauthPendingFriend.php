 ...
 */
class PendingFriend extends \Claroline\CoreBundle\Entity\Oauth\PendingFriend implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'ip', 'host', 'name'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PendingFriend $proxy) {
