 ...
 */
class WorkspaceTagHierarchy extends \Claroline\CoreBundle\Entity\Workspace\WorkspaceTagHierarchy implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'user', 'tag', 'parent', 'level'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WorkspaceTagHierarchy $proxy) {
