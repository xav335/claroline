 ...
 */
class CompetencyProgress extends \HeVinci\CompetencyBundle\Entity\Progress\CompetencyProgress implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'HeVinci\\CompetencyBundle\\Entity\\Progress\\CompetencyProgress' . "\0" . 'date', 'id', 'competency', 'user', 'level', 'percentage', 'competencyName', 'userName', 'levelName'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CompetencyProgress $proxy) {
    ...
    public function getCompetencyName()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCompetencyName', []);

        return parent::getCompetencyName();
    }
