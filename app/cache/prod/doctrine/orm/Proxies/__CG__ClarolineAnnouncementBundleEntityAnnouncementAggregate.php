 ...
 */
class AnnouncementAggregate extends \Claroline\AnnouncementBundle\Entity\AnnouncementAggregate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'announcements', 'id', 'resourceNode', 'name', 'mimeType'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AnnouncementAggregate $proxy) {
