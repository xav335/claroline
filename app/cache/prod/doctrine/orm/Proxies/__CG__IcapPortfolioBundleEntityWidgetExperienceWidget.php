 ...
 */
class ExperienceWidget extends \Icap\PortfolioBundle\Entity\Widget\ExperienceWidget implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'widgetType', 'post', 'companyName', 'startDate', 'endDate', 'description', 'website', 'id', 'label', 'createdAt', 'updatedAt', 'portfolioWidgets', 'user'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ExperienceWidget $proxy) {
