 ...
 */
class GridRowItem extends \UJM\ExoBundle\Entity\Misc\GridRowItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Misc\\GridRowItem' . "\0" . 'row', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Misc\\GridRowItem' . "\0" . 'item', '' . "\0" . 'UJM\\ExoBundle\\Entity\\Misc\\GridRowItem' . "\0" . 'order'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GridRowItem $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setRow(\UJM\ExoBundle\Entity\Misc\GridRow $row)
    {
