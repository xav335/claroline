 ...
 */
class ShareAction extends \Icap\SocialmediaBundle\Entity\ShareAction implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'network', 'id', 'url', 'title', 'creationDate', 'resource', 'user'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ShareAction $proxy) {
