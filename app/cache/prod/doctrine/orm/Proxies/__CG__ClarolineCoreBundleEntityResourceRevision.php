 ...
 */
class Revision extends \Claroline\CoreBundle\Entity\Resource\Revision implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'version', 'text', 'content', 'user'];
        }
     ...
     * {@inheritDoc}
     */
    public function setText(\Claroline\CoreBundle\Entity\Resource\Text $text)
    {
