 ...
 */
class Tag extends \Icap\BlogBundle\Entity\Tag implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'slug', 'weight', '' . "\0" . 'Icap\\BlogBundle\\Entity\\Tag' . "\0" . 'posts'];
        }
