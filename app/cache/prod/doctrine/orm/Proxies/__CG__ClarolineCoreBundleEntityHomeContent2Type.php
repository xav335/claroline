 ...
 */
class Content2Type extends \Claroline\CoreBundle\Entity\Home\Content2Type implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Claroline\\CoreBundle\\Entity\\Home\\Content2Type' . "\0" . 'id', '' . "\0" . 'Claroline\\CoreBundle\\Entity\\Home\\Content2Type' . "\0" . 'content', '' . "\0" . 'Claroline\\CoreBundle\\Entity\\Home\\Content2Type' . "\0" . 'type', '' . "\0" . 'Claroline\\CoreBundle\\Entity\\Home\\Content2Type' . "\0" . 'size', '' . "\0" . 'Claroline\\CoreBundle\\Entity\\Home\\Content2Type' . "\0" . 'collapse', '' . "\0" . 'Claroline\\CoreBundle\\Entity\\Home\\Content2Type' . "\0" . 'next', '' . "\0" . 'Claroline\\CoreBundle\\Entity\\Home\\Content2Type' . "\0" . 'back'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Content2Type $proxy) {
    ...
    public function setCollapse($collapse)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCollapse', [$collapse]);

        return parent::setCollapse($collapse);
    }
    ...
    public function isCollapse()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isCollapse', []);

        return parent::isCollapse();
    }
     ...
     * {@inheritDoc}
     */
    public function setNext(\Claroline\CoreBundle\Entity\Home\Content2Type $next = NULL)
    {
     ...
     * {@inheritDoc}
     */
    public function setBack(\Claroline\CoreBundle\Entity\Home\Content2Type $back = NULL)
    {
     ...
     * {@inheritDoc}
     */
    public function setFirst(\Claroline\CoreBundle\Entity\Home\Content2Type $first = NULL)
    {
