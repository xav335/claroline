 ...
 */
class CompetencyProgressLog extends \HeVinci\CompetencyBundle\Entity\Progress\CompetencyProgressLog implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'HeVinci\\CompetencyBundle\\Entity\\Progress\\CompetencyProgressLog' . "\0" . 'date', 'id', 'competency', 'user', 'level', 'percentage', 'competencyName', 'userName', 'levelName'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CompetencyProgressLog $proxy) {
