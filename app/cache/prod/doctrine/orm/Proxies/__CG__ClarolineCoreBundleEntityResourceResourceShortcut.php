 ...
 */
class ResourceShortcut extends \Claroline\CoreBundle\Entity\Resource\ResourceShortcut implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'target', 'id', 'resourceNode', 'name', 'mimeType'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ResourceShortcut $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setTarget(\Claroline\CoreBundle\Entity\Resource\ResourceNode $target)
    {
