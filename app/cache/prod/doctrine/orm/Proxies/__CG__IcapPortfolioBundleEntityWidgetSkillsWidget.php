 ...
 */
class SkillsWidget extends \Icap\PortfolioBundle\Entity\Widget\SkillsWidget implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'widgetType', 'skills', 'id', 'label', 'createdAt', 'updatedAt', 'portfolioWidgets', 'user'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SkillsWidget $proxy) {
