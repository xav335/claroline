 ...
 */
class DocumentModel extends \Claroline\CursusBundle\Entity\DocumentModel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'content', 'documentType'];
        }
