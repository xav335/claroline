 ...
 */
class Content extends \Claroline\CoreBundle\Entity\Content implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Claroline\\CoreBundle\\Entity\\Content' . "\0" . 'id', '' . "\0" . 'Claroline\\CoreBundle\\Entity\\Content' . "\0" . 'title', '' . "\0" . 'Claroline\\CoreBundle\\Entity\\Content' . "\0" . 'content', '' . "\0" . 'Claroline\\CoreBundle\\Entity\\Content' . "\0" . 'type', '' . "\0" . 'Claroline\\CoreBundle\\Entity\\Content' . "\0" . 'created', '' . "\0" . 'Claroline\\CoreBundle\\Entity\\Content' . "\0" . 'modified', '' . "\0" . 'Claroline\\CoreBundle\\Entity\\Content' . "\0" . 'locale'];
        }
