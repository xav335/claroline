 ...
 */
class QuestionModel extends \Claroline\SurveyBundle\Entity\QuestionModel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'title', 'questionType', 'workspace', 'details', 'richText'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (QuestionModel $proxy) {
    ...
    public function getQuestionType()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getQuestionType', []);
    ...
    public function setQuestionType($questionType)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setQuestionType', [$questionType]);
