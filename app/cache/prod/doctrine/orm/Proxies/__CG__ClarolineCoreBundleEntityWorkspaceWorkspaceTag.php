 ...
 */
class WorkspaceTag extends \Claroline\CoreBundle\Entity\Workspace\WorkspaceTag implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'user', 'workspace'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WorkspaceTag $proxy) {
