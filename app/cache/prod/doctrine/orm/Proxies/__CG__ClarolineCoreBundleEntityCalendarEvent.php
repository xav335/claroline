 ...
 */
class Event extends \Claroline\CoreBundle\Entity\Calendar\Event implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'type', 'name', 'description', 'user', 'workspace', 'timeSlot', 'details'];
        }
     ...
     * {@inheritDoc}
     */
    public function setTimeSlot(\Claroline\CoreBundle\Entity\Calendar\TimeSlot $timeSlot)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTimeSlot', [$timeSlot]);
    ...
    public function getTimeSlot()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTimeSlot', []);
