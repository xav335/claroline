...
namespace Proxies\__CG__\Icap\OAuthBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class OauthUser extends \Icap\OAuthBundle\Entity\OauthUser implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'oauthId', 'service', 'user'];
        }
    ...
    public function getOauthId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getOauthId', []);
    ...
    public function setOauthId($oauthId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setOauthId', [$oauthId]);
