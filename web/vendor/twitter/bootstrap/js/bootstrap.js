...
(function(){'use strict';window.Claroline=window.Claroline||{};window.Claroline.Sidebar={'displayed':null,'resizeWindow':null,'scrollUp':null,'scrollDown':null};var sidebar=window.Claroline.Sidebar;sidebar.initialize=function(side){var sidebar=$('#'+side+'-bar');if(sidebar.html().replace(/^\s+/g,'').replace(/\s+$/g,'')!==''){sidebar.parent().removeClass('hide');var hasIcon=false;$('.list-group-item.disabled',sidebar).children().each(function(){var className=$(this).prop('class');if(className.match(/^fa-/)!==null){hasIcon=true;return;}});if(!hasIcon){var icon=(side==='left')?'right':'left';var header='<i class="fa fa-caret-'+icon+'"></i>'+
