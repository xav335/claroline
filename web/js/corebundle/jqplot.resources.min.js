(function($){'use strict';$.jqplot.config.defaultColors=["#3366CC","#DC3912","#FF9900","#109618","#990099","#0099C6","#DD4477","#66AA00","#B82E2E","#316395","#994499","#22AA99","#AAAA11","#6633CC","#E67300","#8B0707","#651067","#329262","#5574A6","#3B3EAC","#B77322","#16D620","#B91383","#F4359E","#9C5935"];$.jqplot.config.defaultNegativeColors=["#cc9933","#12B5DC","#0066FF","#96108E","#009900","#C62D00","#44DDAA","#4400AA","#2EB8B8","#956331","#449944","#AA2233","#1111AA","#99CC33","#0073E6","#078B8B","#126710","#923262","#A68755","#ACA93B","#2266B7","#D616CC","#13B949","#35F48B","#35789C"];})(jQuery);
...
if(this.show){var series=this._series,s;var elem=document.createElement('table');this._elem=$(elem);elem=null;this._elem.addClass('jqplot-legend jqplot-cursor-legend');this._elem.css('position','absolute');var pad=false;for(var i=0;i<series.length;i++){s=series[i];if(s.show&&s.showLabel){var lt=$.jqplot.sprintf(this.formatString,s.label.toString());if(lt){var color=s.color;if(s._stack&&!s.fill){color='';}
