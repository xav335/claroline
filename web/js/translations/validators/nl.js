(function (Translator) {
    ...
    Translator.add("6_parameters_min_msg", "Elke regel moet 6 instelligen bevatten (gescheiden door een puntkomma).", "validators", "nl");
    Translator.add("7_parameters_min_msg", "Elke regel moet 7 instelligen bevatten (gescheiden door een puntkomma).", "validators", "nl");
    Translator.add("2047_characters_max", "U bent niet toegelaten de limiet van 2047 tekens te overschrijden.", "validators", "nl");
    Translator.add("Each row requires 2 parameters.", "Elke regel moet 2 instelligen bevatten (gescheiden door een puntkomma).'", "validators", "nl");
    Translator.add("Each row requires at least 5 parameters.", "Elke regel moet tenminste 5 instelligen bevatten (gescheiden door een puntkomma).", "validators", "nl");
    Translator.add("The code {{ code }} is already assigned to another workspace.", "De {{ code }} code is al toegewezen aan een andere werkruimte.", "validators", "nl");
    Translator.add("The name {{ name }} is already in use.", "De naam {{ name }} is al gebruikt.", "validators", "nl");
    Translator.add("The user or group {{ name }} does not exist.", "De gebruiker of de groep [{{ name }}] bestaat niet.", "validators", "nl");
    Translator.add("google_meta_tag_error", "Het veld moet een meta-tag zijn. Voorbeeld : <meta name=\"google-site-verification\" content=\"XXX\" \/>.'", "validators", "nl");
    Translator.add("invalid_date_range", "De einddatum mag de begindatum niet voorafgaan.", "validators", "nl");
    Translator.add("invalid_size_message", "Deze opslageenheid is niet geldig (B, KB, MB, GB).", "validators", "nl");
    Translator.add("name_required", "De naam is vereist", "validators", "nl");
    Translator.add("need_at_least_one_translation", "U moet tenminste \u00e9\u00e9n volledige vertaling leveren.", "validators", "nl");
    Translator.add("password_mismatch", "De wachtwoorden komen niet overeen.", "validators", "nl");
    Translator.add("port_error", "De poort moet een nummer zijn.", "validators", "nl");
    Translator.add("public_profile_url_not_valid", "De URL van uw openbaar profiel is niet geldig.", "validators", "nl");
    Translator.add("role_already_exists", "Deze rol bestaat al.", "validators", "nl");
    Translator.add("special_char_not_allowed", "De speciale tekens worden niet aanvaard. De toegelaten tekens zijn : a-z, A-Z, 0-9, @, _, - en.", "validators", "nl");
    Translator.add("username_doesnt_exist", "De gebruiker %username% bestaat niet.", "validators", "nl");
    Translator.add("valid_end_date_required", "Een geldige einddatum is vereist.", "validators", "nl");
    Translator.add("valid_end_hour_required", "Een einduur valide is vereist.", "validators", "nl");
    Translator.add("valid_start_date_required", "Een geldige begindatum is vereist.", "validators", "nl");
    Translator.add("valid_start_hour_required", "Een geldig beginuur is vereist.", "validators", "nl");
    Translator.add("value_not_blank", "Deze waarde mag niet leeg zijn.", "validators", "nl");
    Translator.add("email_not_valid", "Deze email is niet geldig.", "validators", "nl");
    Translator.add("invalid_domain_name", "Deze domeinnaam is niet geldig.", "validators", "nl");
    Translator.add("date_range_too_small", "Het evenement moet tenminste 15 minuten duren.", "validators", "nl");
    Translator.add("valid_date_range_required", "De einddatum mag de startdatum niet voorafgaan of gelijk zijn aan de startdatum.", "validators", "nl");
    Translator.add("valid_max_duration_required", "De maximale reservatieduur voor deze middelen wordt overschreden.", "validators", "nl");
    Translator.add("valid_duration_format_required", "Ongeldig formaat voor de reservatieduur. Moet de vorm hh:mm gebruiken.", "validators", "nl");
    Translator.add("number_reservations_exceeded", "Aantal reservaties overschreden voor deze middel. Gelieve de datum of de middel te wijzigen.", "validators", "nl");
    Translator.add("bad_file_extension", "De uitbreiding van het bestand is niet geldig. Gelieve een CSV-bestand te gebruiken.", "validators", "nl");
    Translator.add("invalid_number_of_column", "Regel %lineNb% van het bestand moet 7 kolommen bevatten.", "validators", "nl");
    Translator.add("invalid_column_headers", "De naam van kolom %columnName% is niet aanwezig in het bestand.", "validators", "nl");
    Translator.add("invalid_number_characters_resource_type", "De tekenreeks van de kolom \"resource_type\" moet tenminste 2 en maximum 50 karakters bevatten. Regel %lineNb%.", "validators", "nl");
    Translator.add("invalid_number_characters_name", "De tekenreeks van de kolom \"name\" moet tenminste 2 en maximum 50 karakters bevatten. Regel %lineNb%.", "validators", "nl");
    Translator.add("invalid_type_for_max_time_reservation", "De kolom \"max_time_reservation\" moet in het formaat hh:mm of hh:mm:ss geschreven worden. Regel %lineNb%.", "validators", "nl");
    Translator.add("invalid_number_characters_localisation", "De tekenreeks van de kolom \"localisation\" moet maximum 255 karakters bevatten. Regel %lineNb%.", "validators", "nl");
    Translator.add("invalid_number_quantity", "De waarde in de kolom \"quantity\" moet tenminste 1 zijn. Regel %lineNb%.", "validators", "nl");
    Translator.add("invalid_color_format", "De waarde van de kleur in de kolom \"color\" moet in het formaat hex geschreven worden. Regel %lineNb%.", "validators", "nl");
    Translator.add("resource_already_exists_for_resource_type", "De naam van de middel bestaat al voor dit type van middel. Regel %lineNb%.", "validators", "nl");
    Translator.add("double_resource_for_one_resource_type", "Regel %lineNb1% en regel %lineNb2% bevatten hetzelfde type van middel voor dezelfde middel. Gelieve de namen van de middelen te onderscheiden.", "validators", "nl");
    Translator.add("website_doesnt_exist %url%", "De website %url% bestaat niet.", "validators", "nl");
    Translator.add("server_error %errorCode%", "Er is een fout gedetecteerd aan de serverzijde. Code fout:%errorCode%.", "validators", "nl");
    Translator.add("client_error %errorCode%", "Er is een fout gedetecteerd aan de klantzijde. Code fout:%errorCode%.", "validators", "nl");
    Translator.add("method_not_allowed", "Deze methode is niet toegestaan.", "validators", "nl");
    Translator.add("res_not_found", "Leermiddel niet gevonden", "validators", "nl");
    Translator.add("access_denied", "U bent niet toegelaten deze webpagina te openen.", "validators", "nl");
    Translator.add("blog_post_need_title", "Gelieve de titel van het artikel te vermelden.", "validators", "nl");
    Translator.add("blog_post_need_content", "Gelieve de inhoud van het artikel te vermelden.", "validators", "nl");
    Translator.add("Bad code value", "Code komt niet overeen", "validators", "nl");
})(Translator);
