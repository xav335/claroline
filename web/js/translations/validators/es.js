(function (Translator) {
    ...
    Translator.add("2047_characters_max", "2047_characters_max", "validators", "es");
    Translator.add("Each row requires 2 parameters.", "Cada fila requiere 2 par\u00e1metros (separados por comas).", "validators", "es");
    Translator.add("Each row requires at least 5 parameters.", "Cada fila requiere al menos 5 par\u00e1metros (separados por comas).", "validators", "es");
    Translator.add("The code {{ code }} is already assigned to another workspace.", "El c\u00f3digo {{ code }} ya est\u00e1 asignado a otro espacio de trabajo.", "validators", "es");
    Translator.add("The name {{ name }} is already in use.", "El nombre {{ name }} ya est\u00e1 en uso.", "validators", "es");
    Translator.add("The user or group {{ name }} does not exist.", "El usuario o grupo [{{ name }}] no existe.", "validators", "es");
    Translator.add("google_meta_tag_error", "Se debe definir una meta etiqueta, ejemplo: <meta name=\"google-site-verification\" content=\"XXX\" \/>", "validators", "es");
    Translator.add("invalid_date_range", "La fecha de finalizaci\u00f3n no puede preceder a la fecha de inicio.", "validators", "es");
    Translator.add("invalid_size_message", "invalid_size_message", "validators", "es");
    Translator.add("name_required", "El Nombre es obligatorio.", "validators", "es");
    Translator.add("need_at_least_one_translation", "Al menos una traducci\u00f3n debe estar definida", "validators", "es");
    Translator.add("password_mismatch", "Las contrase\u00f1as no coinciden", "validators", "es");
    Translator.add("port_error", "El puerto debe ser un n\u00famero", "validators", "es");
    Translator.add("public_profile_url_not_valid", "Su URL p\u00fablica de perfil no es v\u00e1lida.", "validators", "es");
    Translator.add("role_already_exists", "El rol ya existe.", "validators", "es");
    Translator.add("special_char_not_allowed", "Los caracteres especiales no est\u00e1n permitidos (los caracteres permitidos son: a-z, A-Z, 0-9, @, _, - y .)", "validators", "es");
    Translator.add("username_doesnt_exist", "L'utilisateur %username% n'existe pas.", "validators", "es");
    Translator.add("valid_end_date_required", "Se requiere una fecha de finalizaci\u00f3n v\u00e1lida.", "validators", "es");
    Translator.add("valid_end_hour_required", "Se requiere una hora de finalizaci\u00f3n v\u00e1lida.", "validators", "es");
    Translator.add("valid_start_date_required", "Se requiere una fecha de inicio v\u00e1lida.", "validators", "es");
    Translator.add("valid_start_hour_required", "Se requiere una hora de inicio v\u00e1lida.", "validators", "es");
    Translator.add("invalid_rss_url", "RSS URL inv\u00e1lida.", "validators", "es");
    Translator.add("badge_automatic_awarding_need_rules", "Las reglas de atribuci\u00f3n deber\u00edan haberse definido para permitir la atribuci\u00f3n autom\u00e1tica de una insignia", "validators", "es");
    Translator.add("badge_expiring_need_period_and_duration", "Un periodo de validez debe estar definido en la insignia", "validators", "es");
    Translator.add("badge_need_at_least_one_translation", "Al menos una traducci\u00f3n debe estar definida en la insignia", "validators", "es");
    Translator.add("badge_need_image", "Una imagen debe estar definida en la insignia", "validators", "es");
    Translator.add("Bad code value", "El valor no coincide", "validators", "es");
})(Translator);
